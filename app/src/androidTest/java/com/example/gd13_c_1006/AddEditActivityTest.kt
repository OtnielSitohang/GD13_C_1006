package com.example.gd13_c_1006
...
class AddEditActivityTest {
    ...
    fun addEditActivityTest() {
        ...
        textInputEditText.perform(scrollTo(), replaceText("Otniel Sadar Herianto Sitoohang"), closeSoftKeyboard())
        ...
        textInputEditText2.perform(scrollTo(), replaceText("200711006"), closeSoftKeyboard())
